...
pandoc -s --dpi=300 --slide-level 2 --toc --listings --shift-heading-level=0 --template default_mod.latex --pdf-engine xelatex -f "$SOURCE_FORMAT" -M date="$DATE_COVER" -V classoption:aspectratio=169 -V lang=en-US -t beamer presentation.md -o presentation.pdf
